...
class pgraph_t: public cfinfo_t {
 ...
 public:    
    ...
    void print_blog() {
      std::cout << "log-size: " << blog->blog_count << std::endl;
      std::cout << "Current batching position: " << blog->blog_head << std::endl;
      std::cout << "Make adj list from this point: " << blog->blog_tail << std::endl;
      std::cout << "Make adj list upto this point: " << blog->blog_marker << std::endl;
      std::cout << "Make edge durable from this point: " << blog->blog_wtail << std::endl;
      std::cout << "Make edge durable upto this point: " << blog->blog_wmarker << std::endl;
    }
